...
<head>
  ...
  <!--  <link href="../css/bootstrapValidator.css" rel="stylesheet">
    ...
    <script src="../js/Student_forms.js"></script>
...
<script>
  ...
  <script>
  var fc;
  function formcheck(jf,js,ju,je,jp,jcp,ja){
    fc=$('#regform').valid();
    if(fc==true){
    return regformhash(jf,js,ju,je,jp,jcp,ja);
  }else {
    return false;
    }
  }
              ...
              <div class="modal-body">
                <div class="well">
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#reg_stud" data-toggle="tab">Create Student Account</a></li>
                      ...
                      <form id="regform" name="registration_form" class="form-horizontal" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="POST">
                        <fieldset class="col-xs-12 col-md-4">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="text" pattern="^[a-zA-Z0-9]+$" maxlength="20" id="Student_ID" name="Student_ID" placeholder="" class="input-xlarge" required>
                            </div>
                          </div>
                          <div class="control-group">
                            <!-- Username -->
                        ...
                        <fieldset class="col-xs-12 col-sm-8">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="text" pattern="^[a-zA-Z]+$" maxlength="30" id="father_name" name="father_name" placeholder="" class="input-xlarge" required>
                            </div>
                          </div>
                          <div class="control-group">
                            <!-- gender -->
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input type="text" pattern="^[0-9]+$" maxlength="4" id="batch" name="batch" placeholder="" class="input-xlarge" required>
                          </div>
                        </div>
                        <div class="control-group">
                          <!-- select department -->
                    ...
                    <div class="tab-pane fade" id="create">
                      <div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-departmet">
                          ...
                          <?php
                            $query=sprintf("SELECT Student_ID, Name, Batch,  Cell_Number FROM `students_details`");
