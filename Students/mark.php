  ...
  <nav class="nav navbar-default navbar-inverse" role="navigation" style="background: #4169e1">
    <div class="container">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"> <a href="#"></span>Marks</a></li>
        <li> <a href="Subject.php"></span>Subject</a></li>
      </ul>
    ...
    <div class="row">
      ...
      <table class="table table-striped table-bordered table-hover" id="dataTables-departmet">
        ...
        <?php
          ...
          $query=sprintf("SELECT Semester, Subject_Code, Internal, External, Grade FROM marks WHERE Student_ID='%s'",$std_id);
